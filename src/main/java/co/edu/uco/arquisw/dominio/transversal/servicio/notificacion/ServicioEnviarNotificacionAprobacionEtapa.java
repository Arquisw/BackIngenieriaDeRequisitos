...
public class ServicioEnviarNotificacionAprobacionEtapa extends ServicioEnviarNotificacion {
    public ServicioEnviarNotificacionAprobacionEtapa(ServicioEnviarCorreoElectronico servicioEnviarCorreoElectronico, PersonaRepositorioConsulta personaRepositorioConsulta) {
    ...
    public void notificar(List<SeleccionDTO> seleccionesDelProyecto, EtapaDTO etapa, FaseDTO fase, ProyectoDTO proyecto, Long versionId, String motivoRechazo) {
        seleccionesDelProyecto.forEach(seleccionDelProyecto -> {
            ...
            var cuerpo = Mensajes.obtenerCuerpoNotificacionAprobacionEtapa(etapa.getNombre(), fase.getNombre(), proyecto.getNombre());
