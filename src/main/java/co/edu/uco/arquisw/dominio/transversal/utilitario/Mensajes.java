...
public class Mensajes {
    ...
    public static final String PATRON_NOMBRE_TIPOREQUISITO_NO_ES_VALIDO = "El nombre del tipo de requisito solo puede contener letras y números.";
    ...
    public static final String NO_EXISTE_VERSION_CON_EL_ID = "No existe una versión con el ID ";
    ...
    public static final String ETAPA_YA_ESTA_COMPLETADA = " ya está completada.";
    ...
    public static final String HA_SIDO_APROBADO_POR_EL_ROL_LIDER_DE_EQUIPO = " ha sido aprobada por el líder del equipo.";
    ...
    public static final String HA_SIDO_ESTABLECIDA_COMO_VERSION_FINAL_POR_LO_TANTO_ESTA_LISTA_PARA_REVISION = " ha sido establecida como versión final por el rol ingeniería, por lo tanto, está lista para su aprobación en la etapa o en el rechazo de la versión si así lo consideras.";
    public static final String HA_SIDO_RECHAZADA_POR_EL_LIDER_DE_EQUIPO_CUYO_MOTIVO_ES = " ha sido rechazada por el líder de equipo. El motivo del rechazo es por ";
