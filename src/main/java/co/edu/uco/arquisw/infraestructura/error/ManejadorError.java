...
public class ManejadorError extends ResponseEntityExceptionHandler {
    ...
    public ManejadorError() {
        ...
        CODIGOS_ESTADO.put(AccionExcepcion.class.getSimpleName(), HttpStatus.BAD_REQUEST.value());
        ...
        CODIGOS_ESTADO.put(ConstanteInvalidaExcepcion.class.getSimpleName(), HttpStatus.INTERNAL_SERVER_ERROR.value());
        CODIGOS_ESTADO.put(EnvioNotificacionesExcepcion.class.getSimpleName(), HttpStatus.INTERNAL_SERVER_ERROR.value());
    }
    ...
    public final ResponseEntity<Error> handleAllExceptions(Exception exception) {
        ...
        if (!ValidarObjeto.esNulo(codigo)) {
            ...
            Error error = new Error(excepcionNombre, Mensajes.OCURRIO_UN_ERROR_POR_FAVOR_CONTACTAR_AL_ADMINISTRADOR);
